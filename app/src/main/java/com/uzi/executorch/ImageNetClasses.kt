...
/**
 * ImageNet 1000 Class Labels Utility
 * Complete mapping of all 1000 ImageNet classes (0-999)
 */
object ImageNetClasses {
    ...
    private val classNames = arrayOf(
        ...
        "American bullfrog", "tree frog", "tailed frog", "loggerhead turtle", "leatherback turtle",
        "mud turtle", "terrapin", "box turtle", "banded gecko", "green gecko",
        "common iguana", "American chameleon", "whiptail lizard", "agama", "frilled lizard",
        "alligator lizard", "Gila monster", "green lizard", "African chameleon", "Komodo dragon",
        "Nile crocodile", "American alligator", "triceratops", "thunder snake", "ringneck snake",
        "hognose snake", "green snake", "king snake", "garter snake", "water snake",
        "vine snake", "night snake", "boa constrictor", "African rock python", "Indian cobra",
        "green mamba", "sea snake", "Saharan horned viper", "eastern diamondback rattlesnake", "sidewinder rattlesnake",
        "trilobite", "harvestman", "scorpion", "yellow garden spider", "barn spider",
        "European garden spider", "southern black widow", "tarantula", "wolf spider", "tick",
        "centipede", "black grouse", "ptarmigan", "ruffed grouse", "prairie grouse",
        ...
        "spoonbill", "flamingo", "little blue heron", "great egret", "bittern bird",
        ...
        "dugong", "sea lion", "Chihuahua", "Japanese Chin", "Maltese",
        ...
        "Bluetick Coonhound", "Black and Tan Coonhound", "Treeing Walker Coonhound", "English foxhound", "Redbone Coonhound",
        ...
        "Dandie Dinmont Terrier", "Boston Terrier", "Miniature Schnauzer", "Giant Schnauzer", "Standard Schnauzer",
        ...
        "bee", "ant", "grasshopper", "cricket insect", "stick insect",
        "cockroach", "praying mantis", "cicada", "leafhopper", "lacewing",
        ...
        "common sorrel horse", "zebra", "pig", "wild boar", "warthog",
        ...
        "howler monkey", "titi monkey", "Geoffroy's spider monkey", "common squirrel monkey", "ring-tailed lemur",
        "indri", "Asian elephant", "African bush elephant", "red panda", "giant panda",
        "barracouta", "eel", "coho salmon", "rock beauty fish", "anemone fish",
        "sturgeon", "gar fish", "lionfish", "puffer fish", "abacus",
        ...
        "bath towel", "bathtub", "station wagon", "beacon", "beaker",
        "bearskin", "beer bottle", "beer glass", "bell tower", "baby bib",
        "tandem bicycle", "bikini", "ring binder", "binoculars", "birdhouse",
        "boathouse", "bobsleigh", "bolo tie", "poke bonnet", "bookcase",
        "bookstore", "bottle cap", "hunting bow", "bow tie", "brass memorial tablet",
        ...
        "chain-link fence", "chain mail", "chainsaw", "storage chest", "chiffonier",
        ...
        "lipstick", "slip-on shoe", "lotion", "music speaker", "loupe magnifying glass",
        "sawmill", "magnetic compass", "messenger bag", "mailbox", "maillot",
        ...
        "motorcycle helmet", "viaduct", "violin", "volleyball", "waffle iron",
    ...
    /**
     * Get ImageNet class name by index (0-999)
     */
    fun getClassName(classIndex: Int): String {
        return if (classIndex in 0 until classNames.size) {
            classNames[classIndex]
        } else {
            "Unknown Class $classIndex"
        }
    }

    /**
     * Get formatted class name with proper capitalization
     */
    fun getFormattedClassName(classIndex: Int): String {
        val className = getClassName(classIndex)
    ...
    /**
     * Get the number of available class names
     */
    fun getClassCount(): Int = classNames.size

    /**
     * Search for class indices by name (case-insensitive)
     */
    fun findClassIndices(searchTerm: String): List<Pair<Int, String>> {
        return classNames.mapIndexedNotNull { index, name ->
            if (name.contains(searchTerm, ignoreCase = true)) {
                index to name
            } else null
        }
    }
     ...
     * Get all class names
     */
    fun getAllClassNames(): Array<String> = classNames.clone()
}
